...
import club.p6e.germ.message.model.MessageBaseDb;
 ...
 * @version 1.0
 */
@Component(DataSourceConfig.HEAD + "PagingPlugin")
...
public class PagingPlugin implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (param instanceof MessageBaseDb) {
            // 初始化一下分页信息
            execute((MessageBaseDb) param);
        }
     ...
     * @param db db 操作的请求参数
     */
    private void execute(MessageBaseDb db) {
