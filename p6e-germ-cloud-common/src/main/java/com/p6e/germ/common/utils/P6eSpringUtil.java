...
public final class P6eSpringUtil {
    ...
    public static <T> Map<String, T> getBeans(final Class<T> tClass) {
        if (APPLICATION == null) {
            throw new NullPointerException(P6eSpringUtil.class + " getBean() ==> APPLICATION param null.");
        } else {
    ...
    public static String getProperty(String value) {
        return getProperty(value, null);
    }

    public static String getProperty(String value, String defValue) {
        final String r = APPLICATION.getEnvironment().getProperty(value);
