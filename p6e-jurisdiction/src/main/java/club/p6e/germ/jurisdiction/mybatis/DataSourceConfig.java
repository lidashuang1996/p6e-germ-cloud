...
public class DataSourceConfig {
    ...
    /** 数据源标识 */
    public static final String HEAD = "P6eJurisdiction";

    /** mapper.java 包路径 */
    public static final String PACKAGE = "club.p6e.germ.jurisdiction.mybatis.mapper";

    /** mapper.xml 文件的相对路径 */
    public static final String MAPPER_LOCATION = "classpath:mappers/jurisdiction/*.xml";
