...
import club.p6e.germ.cloud.console.controller.support.model.BaseContext;
import lombok.Data;
...
public class MessageContext implements Serializable {
    ...
    public static class Group implements Serializable {
        ...
        @Accessors(chain = true)
        @EqualsAndHashCode(callSuper = true)
        public static class ResultDto extends BaseContext.ListResultDto implements Serializable {
        }
